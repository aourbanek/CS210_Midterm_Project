...
public:
    ...
    {
        auto start_listDelete = chrono::high_resolution_clock::now();
        School* current = head;
        School* prev = nullptr;
        ...
        auto end_listDelete = chrono::high_resolution_clock::now();
        auto time_listDelete = chrono::duration<double, micro>(end_listDelete - start_listDelete).count();

        cout << "Item deleted in " << time_listDelete << "us." << endl << endl;

        return;
    }
    void findByName(string name)
    {
        auto start_listSearch = chrono::high_resolution_clock::now();
        ...
        auto end_listSearch = chrono::high_resolution_clock::now();
        auto time_listSearch = chrono::duration<double, micro>(end_listSearch - start_listSearch).count();
        cout << "Item found in " << time_listSearch << "us." << endl;
...
int main()
{
    ...
    for (vector<string> item : data)
    {
        ...
        {
            auto start_listInsert = chrono::high_resolution_clock::now();
            list.insertLast(item[0], item[1], item[2], item[3], item[4]);
            auto end_listInsert = chrono::high_resolution_clock::now();
            auto time_listInsert = chrono::duration<double, micro>(end_listInsert - start_listInsert).count();
            cout << "Item inserted in " << time_listInsert << "us." << endl;
        }
    }
    cout << endl;
